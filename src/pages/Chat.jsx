...
import DownloadToDos from "../components/list/DownloadToDos.jsx"
                                ...
                                >
                                    ...
                                    <div
                                        className={`chat-bubble text-sm ${
                                            isSent ? "bg-[#4d2c72]" : "bg-[#1B2851]"
                                        } text-white`}
                                    >
                                        {msg.type === "weekly_todo_pdf_data" ? (
                                            <div className="flex flex-col gap-2">
                                                <p className="font-bold">
                                                    {msg.title || "Weekly To-Do List"}
                                                </p>
                                                ...
                                                <PDFDownloadLink
                                                    document={
                                                        <DownloadToDos
                                                            groupedEntries={msg.entries || {}}
                                                            listTitle={msg.title || "Weekly To-Do List"}
                                                        />
                                                    }
                                                    fileName="weekly-todo-list.pdf"
                                                    className="inline-block rounded-lg bg-[#EBB537] px-3 py-2 font-bold text-[#1B2851] text-center"
                                                >
                                                    {({ loading }) =>
